...
const mongoUrl = "mongodb+srv://fahmi48:admin48@cluster0.ttxos1l.mongodb.net/?retryWrites=true&w=majority";
...
app.post("/createschedule", async (req, res) => {
      const { mk, bhari, bwaktu} = req.body;
...
app.post("/updateschedule", async (req, res) => {
      const { scheduleId, mk, bhari, bwaktu } = req.body;
